package cn.US.common.task;

import cn.US.bean.Pay;
import cn.US.common.utils.EmailUtils;
import cn.US.common.utils.StringUtils;
    ...
    public void sendEmailJob(){
        ...
        for(Pay p:list){
            ...
            if(StringUtils.isNotBlank(p.getEmail())&&EmailUtils.checkEmail(p.getEmail())) {
                emailUtils.sendTemplateMail(EMAIL_SENDER, p.getEmail(), "【USpay个人收款支付系统】支付失败通知", "pay-fail", p);
            }
        }
